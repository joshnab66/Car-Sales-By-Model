...
- **Microsoft Excel** — PivotTables, PivotCharts, data filtering
- **IBM Cognos Analytics** — Interactive two-page dashboard (Sales & Service)
- **Dataset** — 5 car models, 10 dealers, 24 months of sales and profit data
...
![Sales Dashboard - Cognos](./ServiceDashboard.png)
